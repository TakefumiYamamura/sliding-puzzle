...
\begin{figure}[hbtp]
\begin{center}
\includegraphics[keepaspectratio, width=7cm, bb=0 0 610 445, clip, scale=0.5]{cpuPDBspeedup.png}
\caption{ヒューリスティック関数にPDBを使用したIDA*CPU、BPIDA*、BPIDA*GLOBALの実行時間の比較}
\end{center}
\end{figure}
...
\begin{figure}[hbtp]
\begin{center}
\includegraphics[keepaspectratio, width=7cm, bb=0 0 610 445, clip, scale=0.5]{bpidaPDBspeedup.png}
\caption{ヒューリスティック関数にPDBを使用したIDA*CPU、BPIDA*、BPIDA*GLOBALの実行時間の比較}
\end{center}
\end{figure}
...
\begin{figure}[hbtp]
\begin{center}
\includegraphics[keepaspectratio, width=7cm, bb=0 0 610 445, clip, scale=0.5]{bpidaglobalPDBspeedup.png}
\caption{ヒューリスティック関数にPDBを使用したIDA*CPU、BPIDA*、BPIDA*GLOBALの実行時間の比較}
\end{center}
\end{figure}
