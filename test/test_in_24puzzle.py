...
os.system("/usr/local/cuda/bin/nvcc -std='c++11' -O3 -o ../src/15puzzle_psimple ../src/24puzzle_psimple.cu")
simple_test("../src/./24puzzle_psimple")
os.system("/usr/local/cuda/bin/nvcc -std='c++11' -O3 -o ../src/15puzzle_psimple_with_pdb ../src/24puzzle_psimple_with_pdb.cu")
