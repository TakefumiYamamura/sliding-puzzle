...
int main() {
	...
	string output_file = "../result/yama24_med_expand_result.csv";
	...
	for (int i = 0; i <= 50; ++i)
	{
        ...
        auto diff = end - start;
		writing_file << std::chrono::duration_cast<std::chrono::nanoseconds>(diff).count() / (double)1000000000.0 << endl;
	}
}
